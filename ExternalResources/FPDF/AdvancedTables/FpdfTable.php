 ...
 *
 * FPDF Advanced Table is released under the pdf Addons Software License Agreement.
...
namespace ExternalResources\FPDF\AdvancedTables;

use ExternalResources\FPDF\FPDF;
...
class FpdfTable {
    ...
    public function __construct ($oPdf) {
        ...
        $this->oMulticell = new FpdfMulticell($oPdf);
    ...
    /**
     * Returns the FpdfMulticell instance
     *
     * @access public
            ...
            if (($iLeftHeight >= 0) && ($iLeftHeightRowspan >= 0)) {
                ...
                switch(1){
                    case 1:
                        ...
                        //SITUATION 1:
                        if ((true == $bIsHeader) OR ((false == $bHeaderOnThisPage) AND (false == $bDataOnThisPage) AND (false == $this->bTableSplit) AND ($iLastDataKey > 0)) ){
